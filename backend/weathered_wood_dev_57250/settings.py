"""
Django settings for weathered_wood_dev_57250 project.
...
ROOT_URLCONF = 'weathered_wood_dev_57250.urls'
...
WSGI_APPLICATION = 'weathered_wood_dev_57250.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "weathered_wood_dev_57250 API",
    "DESCRIPTION": "API documentation for weathered_wood_dev_57250 App",
    "VERSION": "v1",
}
